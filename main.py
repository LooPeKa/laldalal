...
async def yes( ans: Message, text ):
	if text in [ 'Начать', 'Купить', 'Продать', 'Курс', 'начать', 'Меню', 'меню', 'курс', 'купить', 'продать' ]:
		if text in [ 'Начать', 'начать', 'меню', 'Меню' ] :
			await ans( f'👑 Добро пожаловать! Это бот автоматической продажи и покупки коинов. \n\n❗ Перед покупкой/продажей обязательно прочитайте правила проведения сделок! vk.com/@gragonshop1-instrukciya-pered-pokupkoiprodazh..\n\n 📤 Продаем - { course_sale / 100 } руб за 1 000 000 коинов. \n 📥 Покупаем - { course / 100 } руб за 1 000 000 коинов. \n\n ❗ Автоматическая сделка только через киви. 🔔 Другие способы оплаты ( вручную через [garanterik|администратора] ): Sberbank/Qiwi card/Yandex Money/Tinkoff', keyboard = main )
